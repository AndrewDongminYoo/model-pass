...
- Configure only public Supabase browser variables in Vercel and deploy the public-opportunity-list Edge Function needed by the home screen.
...
3. The public-opportunity endpoint returns only the specified public fields of active opportunities, and an empty result renders an explicit empty state.
